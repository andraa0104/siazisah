  ...
  >
    <div class="max-w-md w-full">
      <div class="text-center mb-8">
        <div
          class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-2xl mb-4 shadow-lg"
        >
      ...
      <p class="text-center text-gray-600 text-sm mt-6">
        © 2026 SI-AZISAH. All rights reserved.
      </p>
    </div>
