...
func main() {
	...
	public := router.Group("/api/public")
	{
		...
		public.GET("/masjid/:id/transaksi", publicHandler.GetMasjidTransaksi)
		public.GET("/masjid/:id/mustahiq", publicHandler.GetMasjidMustahiq)
		public.GET("/masjid/:id/distribusi", publicHandler.GetMasjidDistribusi)
